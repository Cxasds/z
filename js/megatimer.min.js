(function(){var A=function(g,m){return function(){return g.apply(m,arguments)}},B=[].indexOf||function(g){for(var m=0,y=this.length;m<y;m++)if(m in this&&this[m]===g)return m;return-1},D={}.hasOwnProperty;this.flipchartCss='<link href="//big-dreams.ru/trim-solo/css/timer.min.css" rel="stylesheet" type="text/css">';this.MegaTimer=function(){function g(a,b){this.plateTick=A(this.plateTick,this);this.circleTick=A(this.circleTick,this);this.newTime=A(this.newTime,this);this.id=a;this.params=b;this.timerElements=
this.cloneObject(C);this.tickEvent=[];m(window,"load",function(a){return function(){return a.run()}}(this));m(window,"focus",function(a){return function(){a.initType();return a.newTime(!0)}}(this))}var m,y,z,C;y=null;z=[];C={secundes:{max:60,min:0,text:"giây",value:0,view:!0,updated:!1},minutes:{max:60,min:0,text:"phút",value:0,view:!0,updated:!1},hours:{max:24,min:0,text:"giờ",value:0,view:!0,updated:!1},days:{max:1E3,
min:0,text:"Zile",value:0,view:!0,updated:!1}};g.prototype.destroy=function(){null!=this.interval&&clearInterval(this.interval);null!=this.container&&(this.container.innerHTML="");$("#timer-"+this.id+"-style").remove();return z=[]};g.prototype.run=function(){var a,b,c,d,e,f,l,h;if(null!=this.id&&(b=this.id,0>B.call(z,b))&&(z.push(this.id),this.initView(),this.initType(),null!=this.id)){this.container=document.getElementById("timer"+this.id);this.container.innerHTML="";b=!0;d=[];
